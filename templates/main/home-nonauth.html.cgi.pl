...
h1({-class=>"center",},"Система размещения и поиска предложений и спроса услуг по грузоперевозкам и оказания услуг по работе различной техники"),
p("Добро пожаловать!"),

div({-class=>"row",},

div({-class=>"col s12 m4",},
  img({-src=>"/i/collage1.png", -class=>"yellow card", -style=>"width:100%;", -alt=>"замечательный коллаж"}, ''),
...
p("Сервис “Лови Газель” представляет собой систему размещения и поиска предложений и спроса услуг по грузоперевозкам и оказания услуг по работе различной техники. Система состоит из сайта и Android приложения Google Play."),

p("Используя “Лови газель” вы можете найти или получить предложение по предоставлению грузового, пассажирского, специального транспорта и прочей техники."),
